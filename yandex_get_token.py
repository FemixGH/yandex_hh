...
import time
import jwt
from dowloading import load_documents
    ...
    def get_iam_token(self):
        ...
        try:
            ...
            payload = {
                ...
                'iss': REQUIRED_VARS["SERVICE_ACCOUNT_ID"],
                'iat': now,
                'exp': now + 3600
            }
            ...
            encoded_token = jwt.encode(
                ...
                algorithm='PS256',
                headers={'kid': REQUIRED_VARS["KEY_ID"]}
            )
    ...
    def ask_gpt(self, question):
        ...
        try:
            ...
            headers = {
                ...
                'x-folder-id': REQUIRED_VARS["FOLDER_ID"]
            }

            data = {
                "modelUri": f"gpt://{REQUIRED_VARS["FOLDER_ID"]}/yandexgpt-lite",
                "completionOptions": {
                    "stream": False,
                    "temperature": 0.6,
                    "maxTokens": 2000
